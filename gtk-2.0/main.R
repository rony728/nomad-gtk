...
gtk-color-scheme = "base_color:#f5f5f5"
gtk-color-scheme = "text_color:#0b0b0b"
gtk-color-scheme = "selected_bg_color:#26c6da"
gtk-color-scheme = "selected_fg_color:#ffffff"
gtk-color-scheme = "insensitive_bg_color:#D2D8DD"
gtk-color-scheme = "tooltip_bg_color:#f5f5f5"
gtk-color-scheme = "tooltip_fg_color:#939fb4"
gtk-color-scheme = "titlebar_bg_color:#f5f5f5"
gtk-color-scheme = "titlebar_fg_color:#4d4d4d"
gtk-color-scheme = "menubar_bg_color:#f5f5f5"
gtk-color-scheme = "menubar_fg_color:#4d4d4d"
gtk-color-scheme = "toolbar_bg_color:#eff1f3"
gtk-color-scheme = "toolbar_fg_color:#4d4d4d"
gtk-color-scheme = "menu_bg_color:#eff1f3"
gtk-color-scheme = "menu_fg_color:#4d4d4d"
gtk-color-scheme = "panel_bg_color:#f5f5f5"
gtk-color-scheme = "panel_fg_color:#4d4d4d"
gtk-color-scheme = "link_color:#005d69"
